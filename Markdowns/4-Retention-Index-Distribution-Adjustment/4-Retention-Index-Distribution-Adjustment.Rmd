...
param_fit <- lapply(Compounds, function(cmpd) {
  ...
  suppressWarnings({list(
    "Normal" = tryCatch({fitdistr(distr, "normal")}, error = function(e) {return(NA)}),
    "Log Normal" = tryCatch({fitdistr(distr, "lognormal")}, error = function(e) {return(NA)}),
    "Logistic" = tryCatch({fitdistr(distr, "logistic")}, error = function(e) {return(NA)}),
    "Gamma" = tryCatch({fitdistr(distr, "gamma")}, error = function(e) {return(NA)}),
